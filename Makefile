...
all: boxblur boxblur-cu embossing embossing-cu embossing_stream-cu gaussian_blur gaussian_blur-cu sobel sobel-cu
...
embossing_stream-cu: embossing_stream.cu
	nvcc $(NVFLAGS) -o $@ $<  $(LDLIBS1)
...
clean:
	rm boxblur boxblur-cu embossing out* embossing-cu embossing_stream-cu gaussian_blur gaussian_blur-cu sobel sobel-cu 
